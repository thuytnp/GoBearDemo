...
public class DemoHappyCaseTest {
	...
	public void testGoBearHappyCase() {
		try {
			...
			logger.info("Click on FPGInsurance checkbox.");
			Assert.assertTrue("FPGInsurance checkbox is checked.", isSelectedFPGInsurance);
			Thread.sleep(2000);
			...
			logger.info("Click on Pacific Cross checkbox.");
			Assert.assertTrue("Pacific Cross checkbox is checked.", isSelectedPacificCross);
			Thread.sleep(2000);
			...
			logger.info("Click on Price: High to low radio button.");
			Assert.assertTrue("Price: High to low radio button in Sort is checked.", isSelectedRadioInSort);
			Thread.sleep(2000);
			...
			Assert.assertEquals("Compare size of list cards after filtered and sorted: ", listCardsAfterFiltering.size(),
					listCardsSortedByPriceHighToLow.size());
